...
\texttt{daniel.lengeler@mathematik.uni-freiburg.de}}
\item {\structure{Pavel Zorin-Kranich (Pisa/Tuebingen)} \texttt{pavel.zorin@online.de}}
...
\begin{frame}{Linear and nonlinear waves}
    ...
    \begin{block}{Dissipation and Dispersion}\pause
        \begin{itemize}
        \item {\color{blue}{Dissipation}\/}\pause: Fourier components are damped.\pause
        \item {\color{blue}{Dispersion}\/}\pause: Fourier components of the wave do not travel at
        the same speed.
        \end{itemize}
    \end{block}\pause
...
\begin{frame}
    \begin{block}{Nonlinear theory}\pause
        ...
        {\color{blue}{an-harmonic nonlinear lattices,}\/}\pause {\color{blue}{gas dynamic},\/}
        \pause {\color{blue}{hydromagnetic waves}\/},\pause {\color{blue}{ion-acoustic waves in cold plasma and
        hydrodynamics.}\/}\\\pause
        \color{magenta}{In all these case the nonlinearity counteract the
        dispersion.}
    \end{block}
\end{frame}
